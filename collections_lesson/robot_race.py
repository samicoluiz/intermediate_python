...
# Add your code below!
counter_moves = Counter(move[0] for move in robot_moves)

# Count the number of collisions by robot name
# Add your code below!
counter_collisions = Counter(move[0] for move in robot_moves if move[2] == True)
...
# Add your code below!
for bot in bots:
  score = counter_moves[bot.name] + counter_collisions[bot.name]
  bot_scores.append(BotScoreData(bot.name, counter_moves[bot.name], counter_collisions[bot.name], score))
